...
<?php
	...
	mysqli_query( $connect, "INSERT INTO `cart` (`product_id`, `product_name`, `category`, `price`) VALUES ($product_id, '$product_name', '$category', $price)" )
...
<div class="button2"><a href="index.php">
